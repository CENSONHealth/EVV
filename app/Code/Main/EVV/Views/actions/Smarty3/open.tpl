...
Module: EVV.<br />
Namespace: evv<br />
Author: &lt;kevin@enicity.com&gt;</h3>

Welcome to the home page of your application. Some useful information is below:<br />
<ul>
    <b>Configuration</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Main/EVV/etc/config.xml<br /><br />
    
    <b>Main View</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Main/EVV/Views/actions/Smarty3/open.tpl<br /><br />

    <b>JavaScript File</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Main/EVV/web/js/actions.js<br /><br />
    <b>Tutorials</b>:
    <ul>
